...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<Optional<User>> getUserLogin(@RequestBody AuthenticationRequest request) {
        try {
            Optional<User> user = platziUserDetailsService.getUserLogin(request.getUsername(), request.getPassword());
